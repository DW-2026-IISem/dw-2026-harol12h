...
```bash
mkdir -p src/features/business/inventory/domain/entities
cat > src/features/business/inventory/domain/entities/inventory.entity.ts <<'EOF_BACKEND_MANUAL'
...
#### 12.4 src/features/business/inventory/infrastructure/persistence/models/inventory.model.ts
Modelo Sequelize para la tabla inventory.

```bash
mkdir -p src/features/business/inventory/infrastructure/persistence/models
cat > src/features/business/inventory/infrastructure/persistence/models/inventory.model.ts <<'EOF_BACKEND_MANUAL'
import {
  AutoIncrement,
  Column,
  CreatedAt,
...
#### 12.5 src/features/business/inventory/infrastructure/persistence/repositories/inventory.repository.ts
Repositorio Sequelize para inventario.

```bash
mkdir -p src/features/business/inventory/infrastructure/persistence/repositories
cat > src/features/business/inventory/infrastructure/persistence/repositories/inventory.repository.ts <<'EOF_BACKEND_MANUAL'
import { Injectable } from '@nestjs/common';
import { Op } from 'sequelize';
import {
  buildPaginatedResult,
...
#### 12.14 src/features/business/inventory/application/use-cases/update-inventory.use-case.ts
Caso de uso para actualizar inventario.

```bash
cat > src/features/business/inventory/application/use-cases/update-inventory.use-case.ts <<'EOF_BACKEND_MANUAL'
import { Inject, Injectable } from '@nestjs/common';
...
#### 12.15 src/features/business/inventory/application/use-cases/delete-inventory.use-case.ts
Caso de uso para eliminar inventario.

```bash
cat > src/features/business/inventory/application/use-cases/delete-inventory.use-case.ts <<'EOF_BACKEND_MANUAL'
import { Inject, Injectable } from '@nestjs/common';
import { InventoryNotFoundException } from '../../domain/exceptions/inventory-not-found.exception.js';
import type { IInventoryRepository } from '../../domain/interfaces/inventory-repository.interface.js';
import { INVENTORY_REPOSITORY } from '../../domain/interfaces/inventory-repository.interface.js';
...
#### 12.19 src/features/business/inventory/presentation/http/controllers/inventory.controller.ts
Controller NestJS para inventario.

```bash
mkdir -p src/features/business/inventory/presentation/http/controllers
cat > src/features/business/inventory/presentation/http/controllers/inventory.controller.ts <<'EOF_BACKEND_MANUAL'
import {
  Body,
  Controller,
  Delete,
...
#### 12.20 src/features/business/inventory/inventory.module.ts
Módulo NestJS del feature Inventario.

```bash
cat > src/features/business/inventory/inventory.module.ts <<'EOF_BACKEND_MANUAL'
import { Module } from '@nestjs/common';
import { INVENTORY_REPOSITORY } from './domain/interfaces/inventory-repository.interface.js';
...
```bash
mkdir -p src/features/business/inventory/domain/entities
cat > src/features/business/inventory/domain/entities/inventory.entity.spec.ts <<'EOF_BACKEND_MANUAL'
...
EOF_BACKEND_MANUAL
```
#### 12.27 src/features/business/inventory/application/use-cases/create-inventory.use-case.spec.ts
Prueba unitaria del caso de uso CreateInventoryUseCase.

```bash
mkdir -p src/features/business/inventory/application/use-cases
cat > src/features/business/inventory/application/use-cases/create-inventory.use-case.spec.ts <<'EOF_BACKEND_MANUAL'
...
#### 12.28 src/features/business/inventory/presentation/http/controllers/inventory.controller.spec.ts
Prueba unitaria del controller Inventory.

```bash
mkdir -p src/features/business/inventory/presentation/http/controllers
cat > src/features/business/inventory/presentation/http/controllers/inventory.controller.spec.ts <<'EOF_BACKEND_MANUAL'
...
#### 12.29 src/features/business/inventory/application/use-cases/list-inventory.use-case.spec.ts
Prueba unitaria del caso de uso ListInventoryUseCase.

```bash
cat > src/features/business/inventory/application/use-cases/list-inventory.use-case.spec.ts <<'EOF_BACKEND_MANUAL'
...
```bash
cat > src/features/business/inventory/application/use-cases/get-inventory.use-case.spec.ts <<'EOF_BACKEND_MANUAL'
...
#### 16.1 src/features/business/payments/domain/entities/payment.entity.ts

```bash
mkdir -p src/features/business/payments/domain/entities
cat > src/features/business/payments/domain/entities/payment.entity.ts <<'EOF_BACKEND_MANUAL'
...
#### 17.9 src/features/business/returns/application/dto/update-return.dto.ts
```bash
cat > src/features/business/returns/application/dto/update-return.dto.ts <<'EOF_BACKEND_MANUAL'
import { ApiPropertyOptional } from '@nestjs/swagger';
...
#### src/features/business/promotions/infrastructure/persistence/models/promotion.model.ts
```bash
mkdir -p src/features/business/promotions/infrastructure/persistence/models
cat > src/features/business/promotions/infrastructure/persistence/models/promotion.model.ts <<'EOF_BACKEND_MANUAL'
import {
  AutoIncrement,
  Column,
  CreatedAt,
...
#### 19.5 src/features/business/promotions/infrastructure/persistence/repositories/promotion.repository.ts
```bash
mkdir -p src/features/business/promotions/infrastructure/persistence/repositories
cat > src/features/business/promotions/infrastructure/persistence/repositories/promotion.repository.ts <<'EOF_BACKEND_MANUAL'
import { Injectable } from '@nestjs/common';
import {
  buildPaginatedResult,
  normalizePagination,
