...
let ListInventoryUseCase = class ListInventoryUseCase {
    inventoryRepository;
    ...
    async execute(filter) {
        ...
        return {
            items: result.items.map((i) => InventoryMapper.toResponse(i)),
            meta: result.meta,
        };
    }
};
ListInventoryUseCase = __decorate([
    Injectable(),
    __param(0, Inject(INVENTORY_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], ListInventoryUseCase);
export { ListInventoryUseCase };
//# sourceMappingURL=list-inventory.use-case.js.map