...
let ListOrderDetailsUseCase = class ListOrderDetailsUseCase {
    ...
    async execute(filter) {
        ...
        return {
            items: result.items.map((d) => OrderDetailMapper.toResponse(d)),
            meta: result.meta,
        };
    }
};
ListOrderDetailsUseCase = __decorate([
    Injectable(),
    __param(0, Inject(ORDER_DETAIL_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], ListOrderDetailsUseCase);
export { ListOrderDetailsUseCase };
//# sourceMappingURL=list-order-details.use-case.js.map