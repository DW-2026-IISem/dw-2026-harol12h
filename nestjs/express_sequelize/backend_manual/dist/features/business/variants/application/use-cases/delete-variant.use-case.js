...
let DeleteVariantUseCase = class DeleteVariantUseCase {
    variantRepository;
...
DeleteVariantUseCase = __decorate([
    Injectable(),
    __param(0, Inject(VARIANT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], DeleteVariantUseCase);
export { DeleteVariantUseCase };
//# sourceMappingURL=delete-variant.use-case.js.map