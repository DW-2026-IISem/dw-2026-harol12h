...
let CreateVariantUseCase = class CreateVariantUseCase {
    variantRepository;
...
CreateVariantUseCase = __decorate([
    Injectable(),
    __param(0, Inject(VARIANT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], CreateVariantUseCase);
export { CreateVariantUseCase };
//# sourceMappingURL=create-variant.use-case.js.map